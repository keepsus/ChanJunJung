...
public class IdSearch extends JFrame implements ActionListener {
	...
	private JLabel nameL, mailL, mail;
	private JTextField nameT, mailT1, mailT2;

	public IdSearch() {
		// JFrame 생성
		setTitle("아이디찾기"); // JFram title 명명
		...
		layeredPane.add(nameP, new Integer(1));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == sureBtn) {
			...
			msg = dao.idSearch(nameT.getText(), mailT1.getText(), mailT2.getText());
			if (msg == null) {
				JOptionPane.showMessageDialog(this, "등록된 아이디가 없습니다.");
			} else {
				JOptionPane.showMessageDialog(this, "아이디는   "+msg+"   입니다.");
				setVisible(false);
			}
